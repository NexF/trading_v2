#! /bin/bash
# 交易时间内每天三点半执行
# 30 15 * * 1-5 /bin/bash /www/dk_project/dk_app/alpine/data/trading_v2/tools/data/autorun_1d.sh >> /www/dk_project/dk_app/alpine/data/trading_v2/tools/data/cron_1d.log 2>&1
